...
その大きな足掛かりとして、現在取り組んでいるプロジェクトがNekkoCloudです。
私たちは、このプラットフォームを足掛かりに、様々なネットワークコンテンツに取り組んでいく予定です。
...
技術スタック: Kubernetes, Docker, Terraform, Go, Python, Kotlin, Database, git  
...
使用ソフト: Nextcloud, ClickUp, Discord, Draw.io, テキストエディタ  
技術スタック: Docker, Go, JavaScript/TypeScript, Python, Kotlin, Database, git  
